...
def is_session_valid():
    ...
    Returns:
    - True: if 15 minutes has not passed (is valid)
    - False: if 15 minutes has passed (not valid)
    ...
    # Returns True if less than 15min has passed since last session creation
...
if __name__ == '__main__':
    ...
    # info = get_match_deatils_BATCH(match_id_list=["1326859098","1326853910", "1326414477"])
    #info = get_matchids_by_queue(queue=451,date='20230926', hour="4,10")
    info = get_player_status(player_id="TheLermster")
